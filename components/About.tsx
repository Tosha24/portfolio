    ...
    >
      ...
      <div>
        <p className="text-justify tracking-wide font-medium text-textDark flex-row">
          Hello, I'm a <span className="text-textGreen">Computer Engineer</span>{" "}
          based in India. As a student pursuing a Bachelor' degree, I am
          committed to using data to gain valuable insights that drive informed
          ...
          looking for someone who is adaptable, result-driven, and committed to
          excellence, please feel free to{" "}
